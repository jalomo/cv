...
public class chat_inicio extends Activity {
		...
		*/
		...
		button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				progress1 = new ProgressDialog(chat_inicio.this);
	...
	public void login_maestro(){
		Toast.makeText(chat_inicio.this, clave_persona, Toast.LENGTH_SHORT).show();
		//actualizaclientes.sendEmptyMessage(0);
		
		
       if(clave_persona.equals("0")){
    	   actualizaclientes.sendEmptyMessage(0);
			Toast.makeText(chat_inicio.this, "NO ENTRO ", Toast.LENGTH_SHORT).show();
		}else{
			
			Toast.makeText(chat_inicio.this, "SI ENTRO ", Toast.LENGTH_SHORT).show();
			registro();
		}
	...
	private static Handler actualizaclientes = new Handler() {
	    ...
	    public void exito(){
	    	...
	    	if(idAgente.trim().equals("0")){
				//pass incorrecto
					Toast.makeText(chat_inicio.this, "usuario o contraseña incorrectos"+idAgente, Toast.LENGTH_SHORT).show();
				}else{
					...
					Toast.makeText(chat_inicio.this, "entro"+idAgente, Toast.LENGTH_SHORT).show();
