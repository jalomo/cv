...
public class circularAdapter extends BaseAdapter {
    ...
    public circularAdapter(Activity a,ArrayList<HashMap<String, String>> d) {
        activity = a;
        data=d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View vi=convertView;
        if(convertView==null)
            vi = inflater.inflate(R.layout.list_item_circular, null);
        ...
        direccion.setText(campos.get(circulares.TAG_direccion));
