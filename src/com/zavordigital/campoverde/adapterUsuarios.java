...
public class adapterUsuarios extends BaseAdapter {
   ...
   public adapterUsuarios(Activity a,ArrayList<HashMap<String, String>> d) {
       activity = a;
       data=d;
   ...
   public View getView(int position, View convertView, ViewGroup parent) {
       ...
       email.setText(campos.get(lista_usuarios.TAG_email));
       id.setText(campos.get(lista_usuarios.TAG_id));
